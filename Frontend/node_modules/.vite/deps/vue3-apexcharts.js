...
var ae = defineComponent({
  ...
  setup(t) {
    ...
    return onServerPrefetch(async () => {
      try {
        const { default: r } = await import("./apexcharts.ssr.esm-fe46cd2d-W37DDEFN.js"), n = Object.assign({}, t.options, {
...
var P = defineComponent({
  ...
  setup(t) {
    ...
    onMounted(async () => {
      try {
        const { default: r } = await import("./apexcharts.ssr.esm-fe46cd2d-W37DDEFN.js");
